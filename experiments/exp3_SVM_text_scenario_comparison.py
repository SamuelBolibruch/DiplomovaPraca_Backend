...
# Experiment 3 – SVM: Porovnanie shared_text (data/training) vs personal_text (data/training_personal)
#              pri fixnom modeli SVM a rovnakom scenári ako v experimentoch 1 a 2
...
RESULTS_DIR       = os.path.join(os.path.dirname(__file__), "results", "exp3_SVM_text_scenario_comparison")
RANDOM_STATE      = 42
...
def plot_eer_comparison(summary_df: pd.DataFrame, out_dir: str):
    ...
    ax.set_title("Experiment 3 SVM – EER: shared_text vs personal_text (SVM)")
    ax.set_ylabel("EER")
...
def plot_far_frr_comparison(summary_df: pd.DataFrame, out_dir: str):
    ...
    ax.set_title("Experiment 3 SVM – FAR a FRR: shared_text vs personal_text (SVM)")
...
def main():
    print("=" * 80)
    print("Experiment 3 – SVM: shared_text vs personal_text")
    ...
    # -----------------------------------------------------------------------
    print("=" * 90)
    print("SÚHRN – SVM – priemery a smerodajné odchýlky cez všetkých používateľov")
    print("=" * 90)
    header = (

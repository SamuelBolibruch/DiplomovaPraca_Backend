...
def plot_eer_vs_text_length(summary_df: pd.DataFrame, out_dir: str):
    ...
    ax.set_title("Experiment 5 – EER vs dĺžka textu (RandomForest, personal)")
    ax.set_ylabel("EER")
...
def plot_far_frr_vs_text_length(summary_df: pd.DataFrame, out_dir: str):
    ...
    ax.set_title("Experiment 5 – FAR a FRR vs dĺžka textu (RandomForest, personal)")
...
def main():
    print("=" * 80)
    print("Experiment 5 Personal – RandomForest: vplyv dĺžky textu (personal training data)")
    ...
    print()
    print("=" * 80)
    print("Experiment 5 Personal dokončený.")

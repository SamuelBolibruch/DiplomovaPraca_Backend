# DiplomovaPraca_Backend

Serverová časť systému behaviorálnej biometrickej autentifikácie pre
smartfónovú platformu. Projekt je súčasťou diplomovej práce na FEI STU
v Bratislave (2026).

Systém kombinuje dynamiku písania a údaje z pohybových senzorov
(akcelerometer, gyroskop) ako druhý faktor overenia identity používateľa.

**Súvisiace repozitáre:**

- [Mobilná aplikácia (Android, Kotlin)](https://github.com/SamuelBolibruch/DiplomovaPraca_SamuelBolibruch)
